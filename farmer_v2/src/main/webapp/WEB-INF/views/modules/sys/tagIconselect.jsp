...
<div id="icons">
    ...
    <h2 class="page-header">项目图标</h2>
    <ul class="the-icons">
        <li><i class="icon-farmer"></i> icon-farmer</li>
        <li><i class="icon-farmerland"></i> icon-farmerland</li>
        <li><i class="icon-farmer-plant"></i> icon-farmer-plant</li>
        <li><i class="icon-manager-user"></i> icon-manager-user</li>
        <li><i class="icon-kaiguan"></i> icon-kaiguan</li>
        <li><i class="icon-myinfo"></i> icon-myinfo</li>
        <li><i class="icon-node"></i> icon-node</li>
        <li><i class="icon-relay"></i> icon-relay</li>
        <li><i class="icon-waring"></i> icon-waring</li>
    </ul>
